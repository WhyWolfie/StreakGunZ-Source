...
//	void FinalizeGame();
	...
	bool IsCWChannel() { return m_bLadderGame; }	// DT?
	//bool IsPWChannel() { return m_bPlayerWars; }	// PW
	bool IsPWChannel() { return (m_CurrentChannelType == MCHANNEL_TYPE_PLAYERWARS); } 
