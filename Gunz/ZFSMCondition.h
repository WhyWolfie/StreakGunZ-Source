...
public:
	...
	virtual bool Cond_HasNoTarget() = 0;
	virtual bool Cond_TargetHeightHigher(float fheight) = 0;
	virtual bool Cond_CanSeeTarget() = 0;
	virtual bool Cond_CannotSeeTarget() = 0;
	virtual bool Cond_FailedBuildWayPoints() = 0;
	virtual bool Cond_AngleTargetHeight(float fActorPos1, float fActorPos2) = 0;
	virtual bool Cond_SummonLess(int nArg1) = 0;
