...
void ZPlayerListBox::InitUI(PLAYERLISTMODE nMode)
{
	...
	switch(m_nMode) {
		case PLAYERLISTMODE_CHANNEL:	SetupButton("LobbyTab_Lobby.png","LobbyTab_Lobby.png")
			;break;	
		case PLAYERLISTMODE_STAGE: 		SetupButton("Stage_PlayerList.png","Stage_PlayerList.png")
			;break;	
		case PLAYERLISTMODE_CHANNEL_FRIEND:
		case PLAYERLISTMODE_STAGE_FRIEND: 	SetupButton("LobbyTab_Friends.png","LobbyTab_Friends.png")
			;break;	
		case PLAYERLISTMODE_CHANNEL_CLAN:
		case PLAYERLISTMODE_STAGE_CLAN: 	
		{
			SetupButton("LobbyTab_Clan.png","LobbyTab_Clan.png");
