...
void MAddSharedCommandTable(MCommandManager* pCommandManager, int nSharedType)
{
	...
	if(nSharedType&MSCT_MATCHSERVER || nSharedType&MSCT_CLIENT){
		...
		C(MC_MATCH_JOIN_PLAYERWARS, "knaw65goag", "jnaaw", MCDT_MACHINE2MACHINE);
			P(MPT_INT, "Arg1")
			P(MPT_INT, "Arg2")
...
//			P(MPT_BLOB, "SKey")
		...
		C(MC_MATCH_LADDER_REJOIN, "Ladder.Rejoin", "Rejoin Ladder Game", MCDT_MACHINE2MACHINE)
		C(MC_MATCH_NOTIFY_LADDER_REJOIN, "Ladder.Notify.Rejoin", "Notify Rejoin Ladder Game", MCDT_MACHINE2MACHINE)
		...
		C(MC_QUEST_OBTAIN_ZITEM, "Quest.ObtainZItem", "Obtain ZItem", MCDT_MACHINE2MACHINE)
			P(MPT_UINT, "ItemID");			// ¿œπ› æ∆¿Ã≈€¿« ID
		C(MC_NEWQUEST_OBTAIN_ZITEM, "Quest.NewObtainZItem", "Obtain ZItem", MCDT_MACHINE2MACHINE)
			P(MPT_UID, "uidPicker");			// ¿œπ› æ∆¿Ã≈€¿« ID
			P(MPT_UINT, "ItemID");			// ¿œπ› æ∆¿Ã≈€¿« ID
...
//	CA("connect", "Net.Connect");
	...
	C(MC_MATCH_PLAYERWARS_CHARINFO, "MC_MATCH_PLAYERWARS_CHARINFO", "Player Wars Character Info", MCDT_MACHINE2MACHINE)
		P(MPT_INT, "Ranking")
		P(MPT_INT, "Wins")
		P(MPT_INT, "Loses")
		P(MPT_INT, "Draws")
	...
	// Orby: (AntiLead).
	C(MC_GUNZ_ANTILEAD, "Game.AntiLead", "AntiLead", MCDT_PEER2PEER)
		P(MPT_BLOB, "Blob");
