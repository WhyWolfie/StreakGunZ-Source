...
//challengequest
MQuestChallengePlayerManager::MQuestChallengePlayerManager() : m_pStage(0)
{

}

MQuestChallengePlayerManager::~MQuestChallengePlayerManager()
{

}

void MQuestChallengePlayerManager::Create(MMatchStage* pStage)
{
	m_pStage = pStage;
...
void MQuestChallengePlayerManager::Destroy()
{
	Clear();
}

void MQuestChallengePlayerManager::AddPlayer(MUID& uidPlayer)
{
	MQuestChallengePlayerInfo* pPlayerInfo = new MQuestChallengePlayerInfo();
...
void MQuestChallengePlayerManager::DelPlayer(MUID& uidPlayer)
{
	MQuestChallengePlayerInfo* pDelPlayerInfo = NULL;
...
void MQuestChallengePlayerManager::Clear()
{
	for (iterator itor = begin(); itor != end(); ++itor)
	{
		delete (*itor).second;
...
MQuestChallengePlayerInfo* MQuestChallengePlayerManager::GetPlayerInfo(const MUID& uidPlayer)
{
	iterator itor = find(uidPlayer);
	if (itor != end())
	{
